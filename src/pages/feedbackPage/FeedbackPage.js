...
import feedbackImage from "../../image/feedback-bg.jpg";
...
export default function FeedbackPage() {
    ...
    useEffect(() => {
        const feedback = new Image();
        feedback.src = feedbackImage;
        feedback.onload = () => {
                ...
                <div className='feedbackPage'>
                    ...
                    <div className='feedbackPage__formContainer'>
                        ...
                        >
                            ...
                            <p className='feedbackPage__subtitle'>Поделитесь своими впечатлениями о нашем комиксе. Что
                                вам понравилось больше всего? Какие персонажи вас заинтересовали? Есть ли идеи по
                                улучшению? У вас есть идеи для новых сюжетов или персонажей? Или если у вас возникли
                                проблемы с использованием нашего комикс-создателя, наши специалисты по технической
                                поддержке всегда готовы помочь вам решить их. Дайте нам знать
                                Мы всегда готовы воплотить новые идеи в жизнь.</p>
                            <p className='feedbackPage__titleText'>Имя
                                <span
                                    className='feedbackPage__titleText_lightText'> (Как к Вам лучше обращаться?)</span>
                            </p>
                            <input
